...
import com.langston.jobportal.repository.JobSeekerProfileRepository;
...
public class UsersService {
    ...
    public Users findByEmail(String cuurentUsername) {
        return usersRepository.findByEmail(cuurentUsername)
                .orElseThrow(() -> new UsernameNotFoundException("Could not find user."));
    }
}
